...
// And REPLACE the if/else block that follows it with this new logic:
if (isChecked) {
    reviewButtonLabel.html('<span class="review-icon">🔖</span> Marked for Review');
} else {
    reviewButtonLabel.html('Mark for Review');
}
