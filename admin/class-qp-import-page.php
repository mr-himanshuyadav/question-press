            ...
            <div style="margin-top: 2rem;">
                <details>
                    ...
                    <div style="background: #fff; border: 1px solid #ddd; padding: 1rem; margin-top: 1rem;">
                        <p>Your <code>questions.json</code> file must follow this structure. The `topicName` field is optional, but if provided, the topic will be created or assigned under the group's subject.</p>
