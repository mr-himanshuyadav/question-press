...
class Admin_Menu
{
    ...
    public function register_menus()
    {
        ...
        add_action('admin_head', function () {
            ...
            // Target only the Logs & Reports page
            if ($screen && $screen->id === 'question-press_page_qp-logs-reports') {
                echo '<style>
            /* Set specific widths for the log columns */
            .wp-list-table .column-log_type { width: 120px; }
            .wp-list-table .column-status { width: 110px; text-align: center; }
            .wp-list-table .column-log_date { width: 180px; }
            .wp-list-table .column-log_data { width: 130px; text-align: center; }
            
            /* Allow the message column to take up the remaining space */
            .wp-list-table .column-log_message { width: auto; }
            ...
            /* Optional: Style for the status badge we built earlier */
            .column-status span {
