...
class Export_Page
{
    ...
    private static function generate_zip()
    {
        ...
        foreach ($groups_data as $group) {
            ...
            $source_lineage_names = Terms_DB::get_source_hierarchy_for_question($questions_in_group[0]->question_id); 
            ...
            $group_output = [
                ...
                /* --- ADDED CURRENT AFFAIRS --- */
                'isCurrentAffair' => (bool)$group->is_current_affair,
                'caDate'          => $group->ca_date,
        ...
        $final_json = [
            'schemaVersion'   => '3.3', // Bumped to 3.3
